...
We may pass your details to other companies in our group. We may also pass your details to our agents and subcontractors to help us with any of our uses of your data set out in our Privacy Policy. For example, we may use third parties to assist us with delivering products to you, to analyze data and to provide us with marketing or customer service assistance. <br><br>
...
Welcome to the proptybox.com website (the "Site"). These terms & conditions ("Terms and Conditions") apply to the Site, and all of its divisions, subsidiaries, and affiliate operated Internet sites which reference these Terms and Conditions. This website is owned and operated by FEMI &SAMI BUILDING INTERIOR AND SERVICES LIMITED . For the purposes of this website, "seller", "we", "us" and "our" all refer proptybox.com
...
listings, properties and services representations expressed on this Site are those of the vendor and are not made by us. Submissions or opinions expressed on this Site are those of the individual posting such content and may not reflect our opinions.<br><br>
Membership on proptybox.com is free and  does not charge any fee for browsing and buying on proptybox.com. However proptybox.com reserves the right to charge fee and change its policies from time to time. In particular, proptybox.com may at its sole discretion introduce new services and modify some or all of the existing services offered on proptybox.com. In such an event proptybox.com reserves, without notice to You, the right to introduce fees for the new services offered or amend/introduce fees for existing services, as the case may be. Changes to the Fee and related policies shall automatically become effective immediately once implemented on proptybox.com. Unless otherwise stated, all fees shall be quoted in Nigerian Naira. 
</p>
          </article>
          <article>
              <h3>Use of proptybox.com Website www. proptybox.com</h3>
              <p>You agree, undertake and confirm that your use of proptybox.com shall be strictly governed by the following binding principles:
...
<br><br>
You may not use the Website or any Content for any purpose that is unlawful or prohibited by these Terms of Use, or to solicit the performance of any illegal activity or other activity which infringes the rights of proptybox.com or others.
<br><br>
Solely to enable proptybox.com to use the information you supply us with, so that we are not violating any rights you might have in Your Information, you agree to grant us a non-exclusive, worldwide, perpetual, irrevocable, royalty-free, sub-licensable (through multiple tiers) right to exercise the copyright, publicity, database rights or any other rights you have in Your Information, in any media now known or not currently known, with respect to Your Information. proptybox.com will only use Your Information in accordance with the terms of use and proptybox.com Privacy Policy.
<br><br>
...
proptybox.com shall have all the rights to take necessary action and claim damages that may occur due to your involvement/participation in any way on your own or through group/s of People, intentionally or unintentionally in DoS/DDoS (Distributed Denial of Services).
          ...
          <article>
              <h3>TERMINATION</h3>
              <p>In addition to any other legal or equitable remedies, we may, without prior notice to you, immediately terminate the Terms and Conditions of Use or revoke any or all of your rights granted under the Terms and Conditions of Use.
...
If you are dissatisfied with the Site or with any terms, conditions, rules, policies, guidelines, or practices of FEMI & SANMI BUILDING INTERIOR AND SERVICES LIMITED in operating the Site, your sole and exclusive remedy is to discontinue using the Site
</p>
          </article>
...
.p-header {
  color: #FFF;
  height: 150px;
  background: rgba(67, 135, 245, 0.9) url("../assets/img/pattern.svg") repeat;
}
